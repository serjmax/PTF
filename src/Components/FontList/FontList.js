...
export default class FontList extends Component {
  state = {
    fonts: [
      ...
      {id: 27, name: 'Beshenyi Outline', link: 'Beshenyi-Outline', word: 'DJ Kick & Theo', specimenLink: 'https://www.dropbox.com/s/8w51kofjxfk944g/kw_speciemen_beshenyi.pdf?dl=0', gumroadLink: 'https://gum.co/yvbdA', price: '$25', fontSize: "109px", lineHeight: "203px", marginTop: "-11px"},
      {id: 28, name: 'Kakbudto', link: 'Kakbudto-Regular', word: 'Resistance!!', specimenLink: 'https://www.dropbox.com/s/pitt2h3tcwp5q7v/Kak%20budto.pdf?raw=1', gumroadLink: 'https://gum.co/EFpZW', price: '$20', fontSize: "140px", lineHeight: "203px", marginTop: "-31px"},
      ...
      {id: 26, name: 'Crazy Yellow', link: 'Crazy Yellow-Regular', word: '*Pf&Tf—*19-85', specimenLink: 'https://www.dropbox.com/s/vjmxf0dma1xwd3x/crazy-brazy.pdf?dl=0', gumroadLink: 'https://gum.co/uWVvG', price: '$25', fontSize: "150px", lineHeight: "203px", marginTop: "-11px"},
