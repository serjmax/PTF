...
export default class FontList extends Component {
  state = {
    fonts: [
      ...
      {id: 26, name: 'Crazy Yellow', link: 'Crazy Yellow-Regular', word: 'Бешеный желтый', specimenLink: 'https://www.dropbox.com/s/vjmxf0dma1xwd3x/crazy-brazy.pdf?dl=0', gumroadLink: 'https://gum.co/uWVvG', price: '$25', fontSize: "150px", lineHeight: "203px", marginTop: "-11px"},
      ...
      {id: 2, name: 'Form Bold', link: 'Form-Bold', word: 'GROTESKO RYLLO', specimenLink: 'https://www.dropbox.com/s/fnl5cbv8kaoukmu/Forma%20bold.pdf?raw=1', gumroadLink: 'mailto:vladimir.kolomeytcev@gmail.com', price: '$35', fontSize: "78pt", lineHeight: "184px", marginTop: "0"},
