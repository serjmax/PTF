...
export default class FontList extends Component {
  state = {
    fonts: [
      ...
      {id: 26, name: 'Beshenyi Solid', link: 'Beshenyi-NonRegular', word: 'test', specimenLink: 'https://www.dropbox.com/s/8w51kofjxfk944g/kw_speciemen_beshenyi.pdf?dl=0', gumroadLink: 'https://gum.co/WfRTD', price: '$25', fontSize: "137px", lineHeight: "203px", marginTop: "-11px"},
      {id: 27, name: 'Beshenyi Outline', link: 'Beshenyi-Outline', word: 'test', specimenLink: 'https://www.dropbox.com/s/8w51kofjxfk944g/kw_speciemen_beshenyi.pdf?dl=0', gumroadLink: 'https://gum.co/yvbdA', price: '$25', fontSize: "137px", lineHeight: "203px", marginTop: "-11px"},
