...
export default class FontList extends Component {
  state = {
    fonts: [
      {id: 25, name: 'Rene', link: 'Rene-Regular', word: 'test', specimenLink: 'https://www.dropbox.com/s/9i50yif40w6azqn/Rene.pdf?dl=0', gumroadLink: 'https://gum.co/HqTFC', price: '$30', fontSize: "150px", lineHeight: "203px", marginTop: "-11px"},
      {id: 26, name: 'Beshenyi Solid', link: 'Beshenyi-NonRegular', word: 'test', specimenLink: 'https://www.dropbox.com/s/r2qo7equz293urz/KW_SPECIEMEN_beshenyi_regular.pdf?raw=1', gumroadLink: 'https://gum.co/WfRTD', price: '$25', fontSize: "137px", lineHeight: "203px", marginTop: "-11px"},
      {id: 27, name: 'Beshenyi Outline', link: 'Beshenyi-Outline', word: 'test', specimenLink: 'https://www.dropbox.com/s/y94u6zm02i4dmcm/KW_SPECIEMEN_beshenyi_outline.pdf?raw=1', gumroadLink: 'https://gum.co/yvbdA', price: '$25', fontSize: "137px", lineHeight: "203px", marginTop: "-11px"},
      {id: 28, name: 'Kakbudto', link: 'Kakbudto-Regular', word: 'test', specimenLink: 'https://www.dropbox.com/s/z7hpdgi9d7v3mxt/Kak%20Budto%20Pres.pdf?dl=0', gumroadLink: 'https://gum.co/EFpZW', price: '$20', fontSize: "140px", lineHeight: "203px", marginTop: "-31px"},
      {id: 29, name: 'Halturka Solid', link: 'Halturka-Solid', word: 'test', specimenLink: 'https://www.dropbox.com/s/pz03645gpad543z/kw_speciemen_halturka_solid.pdf?dl=0', gumroadLink: 'https://gum.co/TGjHDw', price: '$25', fontSize: "109px", lineHeight: "203px", marginTop: "-22px"},
      {id: 30, name: 'Halturka Outline', link: 'Halturka-Outline', word: 'test', specimenLink: 'https://www.dropbox.com/s/uv1yixnuyivcnkn/kw_speciemen_halturka_outline.pdf?dl=0', gumroadLink: 'https://gum.co/ULWGY', price: '$25', fontSize: "109px", lineHeight: "203px", marginTop: "-22px"},
      {id: 31, name: 'LetMeSee', link: 'LETMESEE-Regular', word: 'test', specimenLink: 'https://www.dropbox.com/s/d06a1noxkr1abt4/kw_speciemen_letmesee.pdf?dl=0', gumroadLink: 'https://gum.co/DuCFa', price: '$25', fontSize: "109px", lineHeight: "203px", marginTop: "-22px"},
