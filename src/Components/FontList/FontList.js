...
export default class FontList extends Component {
  state = {
    fonts: [
      ...
      {id: 11, name: 'Meteorito Bold', link: 'Meteorito-Bold', word: 'THIS IS FOREST GUMP', specimenLink: 'https://www.dropbox.com/s/8kxdkre3pevl91f/Meteorito.pdf?raw=1', gumroadLink: 'https://gum.co/qHIwm', price: '$25', fontSize: "100px", lineHeight: "171px", marginTop: "0"},
