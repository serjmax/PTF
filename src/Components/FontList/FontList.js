...
export default class FontList extends Component {
  state = {
    fonts: [
      ...
      {id: 26, name: 'Beshenyi Solid', link: 'Beshenyi-NonRegular', word: 'гидро-динамика', specimenLink: 'https://www.dropbox.com/s/r2qo7equz293urz/KW_SPECIEMEN_beshenyi_regular.pdf?raw=1', gumroadLink: 'https://gum.co/WfRTD', price: '$25', fontSize: "137px", lineHeight: "203px", marginTop: "-11px"},
      {id: 27, name: 'Beshenyi Outline', link: 'Beshenyi-Outline', word: 'dj kick & theo', specimenLink: 'https://www.dropbox.com/s/y94u6zm02i4dmcm/KW_SPECIEMEN_beshenyi_outline.pdf?raw=1', gumroadLink: 'https://gum.co/yvbdA', price: '$25', fontSize: "137px", lineHeight: "203px", marginTop: "-11px"},
      ...
      {id: 29, name: 'Halturka Solid', link: 'Halturka-Solid', word: 'Los Amigos', specimenLink: 'https://www.dropbox.com/s/pz03645gpad543z/kw_speciemen_halturka_solid.pdf?dl=0', gumroadLink: 'https://gum.co/TGjHDw', price: '$25', fontSize: "109px", lineHeight: "203px", marginTop: "-22px"},
