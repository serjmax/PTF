...
export default class FontList extends Component {
  state = {
    fonts: [
      ...
      {id: 28, name: 'Kakbudto', link: 'Kakbudto-Regular', word: 'test', specimenLink: 'https://www.dropbox.com/s/582zxym58gks4f6/Kak%20budto.pdf?raw=1', gumroadLink: 'https://gum.co/EFpZW', price: '$20', fontSize: "140px", lineHeight: "203px", marginTop: "-31px"},
